...
import { type ProfileFormData, profileFormSchema } from "@/lib/schemas/profile.schema"
...
import { ArrowLeft, Image as ImageIcon, Save, Upload, User, X } from "lucide-react"
...
export default function EditProfilePage() {
    ...
    useEffect(() => {
        const fieldsToWatch: Array<keyof ProfileFormData> = [
            "name",
            "location",
            "website",
            "phone",
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <Label
                                            htmlFor="avatarInput"
                                            className="inline-flex cursor-pointer items-center gap-2 rounded-md border border-gray-300 px-4 py-2 hover:bg-gray-50"
                                        >
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span
                                        className={`text-xs ${bioValue.length > 500 ? "text-red-500" : "text-gray-500"}`}
                                    >
