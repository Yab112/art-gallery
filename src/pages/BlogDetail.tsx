...
export default function BlogDetailPage() {
    ...
    // Fetch comments
    const { data: commentsData, isLoading: isLoadingComments } = useGetBlogComments(
        blogPost?.id || "",
        commentPage,
        20
    )
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            ...
            <div className="sticky top-0 z-10 border-gray-200 border-b bg-white">
                <div className="mx-auto max-w-4xl px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        {returnTo === "/blog/my-blogs" ? "Back to My Blogs" : "Back to Blog"}
                    </Button>
                </div>
            </div>
            ...
            <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <RelatedBlogsSection currentBlogId={blogPost.id} authorId={blogPost.authorId} />
            </article>
        </div>
    )
}
...
function RelatedBlogsSection({
    ...
    const filteredBlogs =
        relatedBlogs?.data.filter((blog) => blog.id !== currentBlogId).slice(0, 5) || []
        ...
        return (
            <section className="mt-16 border-gray-200 border-t pt-12">
                <div className="mb-6 flex items-center gap-2">
                    ...
                    <h2 className="font-bold text-2xl text-gray-900">More from This Author</h2>
                </div>
