...
export const ArtworkDetails = ({ artwork }: ArtworkDetailsProps) => {
    ...
    return (
        <div className="space-y-2">
            {/* Artist and Title */}
            <div>
                <h1 className="mb-0.5 font-semibold text-gray-900 text-xl">{artwork.artist}</h1>
                <h2 className="mb-2 text-base text-gray-600 italic">
            ...
            {artwork.status === "APPROVED" && (
                <div className="rounded-md border border-gray-200 bg-gray-50 p-2.5">
                    <div className="mb-1 flex items-center gap-1.5">
                        ...
                        <span className="font-medium text-gray-700 text-xs">Curators' Pick</span>
                    </div>
