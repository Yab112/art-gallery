            ...
            >
                <div className="relative">
                    <Heart
                        ...
                        style={{
                            ...
                            transition:
                                "transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), fill 0.2s ease-out, color 0.2s ease-out"
                        }}
                    />
                ...
                `}</style>
                    ...
                    {isAnimating && localIsFavorited && (
                        <div className="-m-3 pointer-events-none absolute inset-0">
                            <div className="absolute inset-0 animate-ripple rounded-full bg-red-500/40" />
                            <div
                                className="absolute inset-0 animate-ripple rounded-full bg-red-500/30"
                                style={{ animationDelay: "0.1s" }}
                            />
                            <div
                                className="absolute inset-0 animate-ripple rounded-full bg-red-500/20"
