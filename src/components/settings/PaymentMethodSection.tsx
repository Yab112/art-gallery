...
import { CheckCircle, CreditCard, Edit, Plus, Trash2 } from "lucide-react"
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="font-semibold text-gray-900 text-lg">Payment Methods</h3>
            ...
            {paymentMethods.length === 0 ? (
                <div className="py-8 text-center text-gray-500">
                    ...
                    <p className="mt-2 text-sm">Add a payment method to receive your earnings</p>
                </div>
            ) : (
