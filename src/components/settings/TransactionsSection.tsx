                ...
                <>
                    ...
                    {transactions.length === 0 ? (
                        <div className="py-8 text-center">
                            <Receipt className="mx-auto mb-2 h-8 w-8 text-gray-400" />
                            ...
                            {transactions.map((transaction) => {
                                ...
                                return (
                                    <div key={transaction.id} className="py-3">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <div className="mb-1 flex items-center gap-2">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                            ...
                                                            {transaction.type === "CREDIT"
                                                                ...
                                                                : transaction.typeLabel ===
                                                                  ...
                                                                  : transaction.order?.items &&
                                                                    ...
                                                                    : "Order Payment"}
                                                            {transaction.order?.items &&
                                                                transaction.order.items.length >
                                                                    1 && (
                                                        ...
                                                        <div className="mt-0.5 flex flex-wrap items-center gap-2 text-gray-600 text-xs">
                                                            <span
                                                            ...
                                                            <span
                                                                className={`rounded px-1.5 py-0.5 font-medium text-[10px] ${getStatusColor(
                                                                    transaction.status
                                                                )}`}
                                                            >
                                        ...
                                        {isExpanded && (
                                            <div className="mt-3 space-y-2 border-gray-100 border-t pt-3">
                                                <div className="grid grid-cols-2 gap-3 text-xs">
                                                    <div>
                                                        <p className="mb-0.5 text-[10px] text-gray-500">
                                                            Transaction ID
                                                        </p>
                                                        <p className="break-all font-mono text-gray-900 text-xs">
                                                            {transaction.id}
                                                        </p>
                                                    </div>
                                                    {transaction.orderId && (
                                                        ...
                                                        <div className="mt-2">
                                                            <div className="grid grid-cols-2 gap-3 text-xs">
                                                                <div>
                                                                    ...
                                                                    <p className="break-all text-gray-900 text-xs">
                                                                        {(
                                                ...
                                                {/* Order Total - Minimal */}
                                                {transaction.order && (
                                                    <div className="flex justify-end border-gray-100 border-t pt-2">
