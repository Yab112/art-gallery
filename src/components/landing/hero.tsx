        ...
        <div className="relative z-10 mx-auto flex h-full min-h-[85vh] max-w-7xl items-center justify-end px-4 py-12">
          ...
          {currentSlideData.content && (
            <div className="text-left">
              <p className="mb-2 font-semibold text-lg text-white">
                {currentSlideData.content.subtitle}
              </p>
              <h1 className="mb-8 max-w-md font-bold text-3xl text-white">
                {currentSlideData.content.title}
              </h1>
              <Button
                variant="outline"
                size="lg"
                className="rounded-full border-white bg-white px-8 py-3 text-black hover:bg-gray-100"
          ...
          <div className="grid items-end gap-10 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-7 lg:border-stone-200 lg:border-l lg:pl-12">
              <p className="max-w-2xl text-[15px] text-gray-600 leading-relaxed sm:text-base">
                Collectors, artists, and professionals ,find modern and
                contemporary work to buy, or bring your own pieces to a global
                audience. {siteName ?? "Art Gallery"} guides you from first
                browse to final sale.
              </p>
