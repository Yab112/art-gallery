...
export function MyBlogsFilters({
  ...
  const hasActiveFilters = searchQuery || statusFilter !== "all" || sortBy !== "createdAt" || sortOrder !== "desc" || dateRange !== "all";
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            value={statusFilter}
            onValueChange={(value: "all" | "published" | "pending" | "draft") => onStatusChange(value)}
            {...({ modal: false } as any)}
          >
