...
export const useMyCollections = (page = 1, limit = 10) => {
    const axiosAuth = useAxiosAuth()
 ...
 */
export const useCollectionArtworks = (collectionId: string, page = 1, limit = 12) => {
    const axiosAuth = useAxiosAuth()
 ...
 */
export const useHotCollections = (limit = 10) => {
    const axiosAuth = useAxiosAuth()
