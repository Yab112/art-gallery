...
export const ACCEPTED_DOCUMENT_FORMATS = ["image/jpeg", "image/jpg", "application/pdf"]

export const FORM_TIPS =
    "Do not hesitate to send any additional information that could help us in our decision making process: description of the piece, how you acquired it, certificate of authenticity, a missing piece / unwanted mark on the work, restoration..."
