...
const fetchTransactions = async (
    ...
    const response = await axios.get(`${getApiBaseUrl()}/api/transactions/my-transactions`, {
        params,
        headers: {
...
export const useGetTransactions = (page = 1, limit = 20, status?: string, provider?: string) => {
    return useQuery({
