...
export const getPresignedImageUploadUrl = async (
    ...
    const response = await api.post<PresignedUrlResponse>("/upload/presigned/image", data)
...
export const getPresignedMultipleImageUploadUrls = async (
    ...
    const response = await api.post<MultiplePresignedUrlsResponse>("/upload/presigned/images", data)
    return response.data
}
...
export const getPresignedDocumentUploadUrl = async (
    ...
    const response = await api.post<PresignedUrlResponse>("/upload/presigned/document", data)
    return response.data
}
